                          ...
                          <div className="w-full border rounded-md overflow-hidden">
                            ...
                            <div className="w-full h-9 border-t overflow-hidden">
                              <input
                                ...
                                value={name}
                                onChange={(e) =>
                                  handleProductMainImageChange(e, id)
                                }
...
// export function BasicDetailsOverlay({ id }: { id: string }) {
//   const [loadingProduct, setLoadingProduct] = useState(false);
//   const [loadingSave, setLoadingSave] = useState(false);
//   const [alertMessageType, setAlertMessageType] = useState<AlertMessageType>(
//     AlertMessageType.NEUTRAL
...
//       try {
//         const upsell = (await getUpsell({ id })) as UpsellType;
//         setMainImage(upsell.mainImage || "");
//         setProducts(upsell.products || []);
//         setBasePrice(upsell.pricing.basePrice || 0);
//         setSalePrice(upsell.pricing.salePrice || 0);
//         setDiscountPercentage(
//           upsell.pricing.discountPercentage?.toString() || ""
//         );
//       } catch (error) {
//         console.error("Error fetching upsell:", error);
//         setAlertMessageType(AlertMessageType.ERROR);
//         setAlertMessage("Failed to fetch upsell data");
//         setShowAlert(true);
//       }
//     };
